...
async def create_category(
    service: Annotated[CategoryService, Depends()], category: CreateCategoryIn
):
...
async def update_category(
    service: Annotated[CategoryService, Depends()], category_id: int, category: UpdateCategoryIn
):
